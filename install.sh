...
latest_release_tag() {
	curl https://api.github.com/repos/arunvelsriram/docker-time-sync-agent/releases/latest \
...
curl -LO https://github.com/arunvelsriram/docker-time-sync-agent/releases/download/$tag_name/Binaries.zip
unzip Binaries.zip
rm -f Binaries.zip
